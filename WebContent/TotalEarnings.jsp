...
<title>BookBid: Total Earnings</title>
</head>
<style>
		body {
...
<body>
	<%
		try {
			...
			out.println("<strong><h2 style='font-size:25px'> Sales report : Total Earnings </h2> </strong>");
			
			String query = "select sum(price) from bought_items";
			ResultSet result = stmt.executeQuery(query);
			if (result.next() && result.getString(1) == null) {
				out.println("<h3 style='font-size:25px'><strong> $0 </strong></h3>");
			}
			else {
				out.println("<br>");
				out.println("<h3 style='font-size:25px'><strong>$" +  result.getString(1) + " </strong></h3>");
				// ITEM DETAILS
