...
<title>BookBid: Earnings Per Item</title>
</head>
<style>
		body {
...
<body>
	<%
		try {
			...
			<h2 style='font-size:25px'><strong>Sales Report: Earnings per Item</strong></h2>
			<br><br>
			<%if (!result.next()) {%>
				<h2 style='font-size:25px'><strong>No items have been bought!</strong></h1>
			<%}
			else {%>
				<br><table>
				<tr>
		        <td><strong> Item </strong></td><td><strong> Earnings </strong></td></tr>
	       		<%int i = 1;
	       		result.beforeFirst();
	   	        while(result.next()) {
	   	        	if (i % 2 != 0) {%>
