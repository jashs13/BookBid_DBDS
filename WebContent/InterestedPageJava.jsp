...
<title>BookBid: Interest Alert</title>
</head>
<style>
	 body {
...
<body>
	<br></br>
	Congratulations, you have successfully set up an alert! You will be notified as soon as an item of your interest is available for auction.
	<br></br>
	<%
	try {
